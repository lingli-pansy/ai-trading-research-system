...
说明系统组件如何交互、AI 如何通过经验改进策略。与 [User_Journey.md](User_Journey.md) 互补；架构总览见 [../system_architecture.md](../system_architecture.md)。
...
通过 CLI 或 run_for_openclaw；command_router、skill_interface 提供统一入口。详见 [../operations.md](../operations.md)。
