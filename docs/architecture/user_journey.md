...
梳理核心用户场景与完整用户旅程。架构总览见 [system_architecture_overview.md](system_architecture_overview.md)，Agent 循环见 [agent_loop.md](agent_loop.md)。
...
- **UC-06**：CLI 或 `run_for_openclaw.py`；报告格式见 [../integration/openclaw_integration.md](../integration/openclaw_integration.md)。

完整 UC 描述见 [../archive/User_Journey.md](../archive/User_Journey.md)。
